...
const ContactForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      toast({
        title: "Erreur",
        description: "Un problème est survenu. Vérifiez les champs et réessayez.",
        className: cn(
    ...
    <form className="min-w-7xl mx-auto sm:mt-4" onSubmit={handleSubmit}>
      ...
      <div className="grid w-full gap-1.5 mb-4">
        ...
        <p className="text-sm text-muted-foreground">
          Je ne partagerai jamais vos données avec qui que ce soit. Promis.
        </p>
      </div>
      ...
      >
        {loading ? (
          ...
          <div className="flex items-center justify-center">
            Envoyer le message <ChevronRight className="w-4 h-4 ml-4" />
          </div>
        )}
        <BottomGradient />
      </Button>
